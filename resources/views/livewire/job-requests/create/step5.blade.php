<div>
    ...
    @if ($image === 'Si')
        <div class="w-2/5 mx-auto">
            <input id="imagePaths" type="file" wire:model="imagePaths" multiple hidden>
            <label for="imagePaths"
                class="flex justify-center py-2 align-middle bg-[#336699] rounded-lg cursor-pointer border-2 border-[#336699] hover:border-white">
                <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" fill="#eeeeee" class="w-1/2 mx-auto"
                    viewBox="0 0 384 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    <path
                        d="M246.6 9.4c-12.5-12.5-32.8-12.5-45.3 0l-128 128c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 109.3V320c0 17.7 14.3 32 32 32s32-14.3 32-32V109.3l73.4 73.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-128-128zM64 352c0-17.7-14.3-32-32-32s-32 14.3-32 32v64c0 53 43 96 96 96H352c53 0 96-43 96-96V352c0-17.7-14.3-32-32-32s-32 14.3-32 32v64c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V352z" />
                </svg>
                <h1 class="text-xl">Subir Imagen</h1>
            </label>
            <div class="mx-auto mb-4 text-center">
                <x-input-error for="imagePaths" />
            </div>
        </div>
    @endif
    <div class="mx-auto mb-4 text-center">
